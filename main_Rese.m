...
procedureType = StaticGeneralAnalyis('initialTimeIncrement',1/10,'timePeriod',1,'minTimeIncrement',1/100,'maxTimeIncrement',1,...
...
materialData(1).materialFcn = @(gradU)NeoHook3D_2PK(gradU,C10,D1);
...
mesh.Loads(3).IntegrationOrder = 1; %Point load
