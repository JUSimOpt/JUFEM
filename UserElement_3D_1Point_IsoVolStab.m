function [Ke,ge,histvar] = UserElement_3D_1Point_IsoVolStab(histvar,materialData,Xc,ue,ieqs,GP,GW,cInc,time,dTime,iter,baseFcnParam, baseFcnParam_1P)
...
%                    BLZeta'*D_vol*BLZeta + BNZeta'*T_vol*BNZeta);   
    ...
    Stab = 1/12*(BLXi'*D*BLXi + BNXi'*T*BNXi + ...
                   BLEta'*D*BLEta + BNEta'*T*BNEta + ...
                   BLZeta'*D*BLZeta + BNZeta'*T*BNZeta);            
               
    Ke =  detJ*( (BL'*D*BL+BN'*T*BN) +Stab );
    ge =  detJ*( (BL'*Sv) + (Stab)*ue);
